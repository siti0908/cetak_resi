...
<body>
	...
	<div class="limiter">
      ...
      <h2 class="text-light"><center>SI NIPOS</center></h2>
    <!-- <h4 class="text-info text-center">PT Pos Indonesia (Persero)</h4> <br> -->

      <i class="bi bi-list toggle-sidebar-btn"></i>
    </div><!-- End Logo -->
      <h3 class="text-light"><center> (MODUL PENCETAKAN RESI)</center></h3>

    <h4 class="text-info text-center">PT Pos Indonesia (Persero)</h4> <br>
           
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
         <h6 class="fw-bold mb-2 text-uppercase">Silahkan Login User NIPOS</h6><br>
        ...
        <?php endif?>
        <?php $status_pegawai = $this->session->flashdata('status_pegawai');?>
        <?php if (isset($status_pegawai)):?>
        <div class='alert alert-danger'>
